...
const useResizeObserver = (callback: () => void, elements: React.RefObject<HTMLElement | null>[], dependencies: DependencyList) => {
  useEffect(() => {
...
const useImageLoader = (seqRef: React.RefObject<HTMLElement | null>, onLoad: () => void, dependencies: DependencyList) => {
  useEffect(() => {
